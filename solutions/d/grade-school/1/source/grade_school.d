...
alias Student = Tuple!(string, "name", uint, "grade");

struct GradeSchool
{
    private Student[] students;

    bool add(string name, uint grade)
    {
    ...
    {
        return students
            .sort!((a, b) => a.grade < b.grade || (a.grade == b.grade && a.name < b.name))
            .map!(s => s.name)
            .array;
    }
}
